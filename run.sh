...
python slu_test.py --model_path ./experiments_test/coach_tr_lstmenc/pm_0/best_model.pth --model_type coach --n_samples 0 --tgt_dm PlayMusic --test_mode seen_unseen
